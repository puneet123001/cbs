...
import 'package:cbs/galleries/men_gallery.dart';
import 'package:cbs/minor_screens/hot_deals.dart';
...
class _OnboardingscreenState extends State<Onboardingscreen>
  ...
  Widget buildAsset() {
    return Image.asset('images/onboard/$assetName.JPEG',fit: BoxFit.cover,);
  }
    ...
    switch (offer) {
      case Offer.kurta:
        Navigator.of(context).pushAndRemoveUntil(
            MaterialPageRoute(
                builder: (context) =>  const SubCatogProducts(
                    fromOnBoarding: true,
                    subcatogName: 'kurta',
                    maincatogName: 'men', )),
            (Route route) => false);
      ...
      case Offer.jacket:
        Navigator.of(context).pushAndRemoveUntil(
            MaterialPageRoute(
                builder: (context) => const MenGalleryScreen(
                      fromOnBoarding: true,
                    )),
            (Route route) => false);
        break;
